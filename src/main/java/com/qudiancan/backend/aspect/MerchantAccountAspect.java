...
@Aspect
@Slf4j
public class MerchantAccountAspect {
    ...
    public MerchantAccountAspect(StringRedisTemplate redisTemplate, AccountRepository accountRepository, AuthorityRepository authorityRepository) {
    ...
    @Pointcut("execution(public * com.qudiancan.backend.controller.merchant.*.*(..))" +
