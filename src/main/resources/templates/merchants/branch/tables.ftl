...
<script>
    layui.use(['table', 'laytpl', 'form', 'layer'], function () {
        ...
        table.on('tool(table)', function (obj) {
            ...
            var event = obj.event;
            if (event === 'update') {
                parent.changeMainBody('/merchants/updateTable?branchId=' + data.branchId + '&tableId=' + data.id);
...
<script type="text/html" id="operationBar">
    ...
    <button class="layui-btn layui-bg-gray layui-disabled" lay-event="update" disabled>更新</button>
    {{# } }}
