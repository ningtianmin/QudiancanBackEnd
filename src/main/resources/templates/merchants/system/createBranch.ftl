...
<div class="layui-container" style="padding: 10px;">
    <div class="layui-form">
        <div class="layui-form-item" style="display: flex; align-items: center; justify-content: center">
            <label style="width: 120px;" class="layui-form-label" for="branchName">门店名称</label>
        ...
        <div class="layui-form-item"
            ...
            <label style="width: 120px;" class="layui-form-label" for="branchNotice">门店公告</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item"
             style="display: flex; align-items: center; justify-content: center;">
            <label style="width: 120px;" class="layui-form-label" for="branchPhone">门店联系手机</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item"
             style="display: flex; align-items: center; justify-content: center">
            <label style="width: 120px;" class="layui-form-label" for="branchAddress">门店地址</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item"
             style="display: flex; align-items: center; justify-content: center">
            <label style="width: 120px;" class="layui-form-label" for="branchLongitude">门店地址经度</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item"
             style="display: flex; align-items: center; justify-content: center">
            <label style="width: 120px;" class="layui-form-label" for="branchLatitude">门店地址纬度</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item"
             style="display: flex; align-items: center; justify-content: center">
            <label style="width: 120px;" class="layui-form-label" for="branchIntroduction">门店介绍</label>
            <div class=" layui-input-inline">
        ...
        <div class="layui-form-item" style="display: flex;align-items: center; justify-content: center">
            <div class="layui-form-label">
                <button class="layui-btn layui-bg-orange" lay-submit lay-filter="createBranch">创建门店</button>
            </div>
            <div class="layui-form-label">
                <button class="layui-btn layui-bg-green"
                        onclick="parent.changeMainBody('/merchants/branchSetting?branchId=${currentBranchId}')">取消创建
                </button>
            </div>
        </div>
    </div>
...
<script>
    layui.use('form', function () {
        ...
        form.on('submit(createBranch)', function (data) {
            $.ajax({
                type: "POST",
                url: "${basePath!}/shops/${currentShopId}/branches",
                data: {
